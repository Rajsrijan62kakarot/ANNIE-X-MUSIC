...
BOT_NAME = getenv("BOT_NAME", "˹ Cᴀʀʟᴀ 🍁 ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "Carla_Probot")
EVALOP = list(map(int, getenv("EVALOP", "7804637858").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002117240104))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/uyludd.jpg"
)
PING_VID_URL = getenv(
    "PING_VID_URL", "https://files.catbox.moe/of7o3c.jpg"
)
PLAYLIST_IMG_URL = "https://files.catbox.moe/es37hu.jpg"
STATS_VID_URL = "https://telegra.ph/file/e2ab6106ace2e95862372.mp4"
TELEGRAM_AUDIO_URL = "https://files.catbox.moe/es37hu.jpg"
TELEGRAM_VIDEO_URL = "https://files.catbox.moe/s95pjx.jpg"
STREAM_IMG_URL = "https://files.catbox.moe/khg05x.jpg"
SOUNCLOUD_IMG_URL = "https://files.catbox.moe/khg05x.jpg"
YOUTUBE_IMG_URL = "https://files.catbox.moe/u17tih.jpg"
SPOTIFY_ARTIST_IMG_URL = "https://files.catbox.moe/of7o3c.jpg"
SPOTIFY_ALBUM_IMG_URL = "https://telegra.ph/file/06679f04da4b2fbbb12d0.jpg"
SPOTIFY_PLAYLIST_IMG_URL = "https://files.catbox.moe/of7o3c.jpg"
...
if SUPPORT_CHANNEL:
    if not re.match(https://t.me/EvoKakarot):
        raise SystemExit(
